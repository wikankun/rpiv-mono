...
1. **Locate the plan**: Use provided path or confirm recent plans via ask_user.
...
5. **Spawn parallel research agents**:
   - @codebase-analyzer to verify requirement implementation.
   - @codebase-pattern-finder to check pattern conformance.
