...
Agent({ subagent_type: "integration-scanner", description: "analyze integration-scanner", prompt: "$PROMPT" })
...
Agent({ subagent_type: "precedent-locator", description: "analyze precedent-locator", prompt: "$PROMPT" })
...
Agent({ subagent_type: "peer-comparator", description: "analyze peer-comparator", prompt: "$PROMPT" })
...
Agent({ subagent_type: "claim-verifier", description: "analyze claim-verifier", prompt: "$PROMPT" })
...
2. **Developer checkpoint**:
   - Present the reconciled findings to the developer via ask_user_question
