...
Agent({ subagent_type: "artifact-code-reviewer", description: "analyze artifact-code-reviewer", prompt: "$PROMPT" })
...
Agent({ subagent_type: "artifact-coverage-reviewer", description: "analyze artifact-coverage-reviewer", prompt: "$PROMPT" })
...
|---|---|
| Step 4 post-finalization code review (mandatory) | Agent({ subagent_type: "artifact-code-reviewer", description: "analyze artifact-code-reviewer", prompt: "$PROMPT" }) |
| Step 4 post-finalization coverage review (mandatory) | Agent({ subagent_type: "artifact-coverage-reviewer", description: "analyze artifact-coverage-reviewer", prompt: "$PROMPT" }) |
