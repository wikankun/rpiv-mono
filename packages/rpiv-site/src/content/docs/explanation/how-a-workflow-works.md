...
Next: [Run a workflow](/docs/guides/run-a-workflow) walks the five bundled workflows and the `/wf` commands. For the narrative version of this same arc, read [The workflow author's tale](/blog/the-workflow-authors-tale).
