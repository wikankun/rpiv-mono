...
- Parallel Agent dispatch — dispatch specialized agents in parallel in the same assistant message (multiple tool_use blocks in one response), never one per turn.
